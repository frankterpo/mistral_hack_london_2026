...
"[project]/node_modules/@generaltranslation/supported-locales/dist/index.cjs.min.cjs [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

var e = __turbopack_context__.r("[project]/node_modules/generaltranslation/dist/index.cjs.min.cjs [app-ssr] (ecmascript)"), r = function() {
...
exports.getSupportedLocale = function(n) {
    var a;
    if (!e.isValidLocale(n)) return null;
    n = e.standardizeLocale(n);
    var l = e.getLocaleProperties(n), o = l.languageCode, s = function(e, r) {
        var t = {};
    ...
    if (null === (a = t[o]) || void 0 === a ? void 0 : a.length) {
        var i = t[o], u = function(e) {
            for(var r = e.locale, t = e.languageCode, n = e.minimizedCode, a = e.regionCode, l = e.scriptCode, o = 0, s = [
                r,
                "".concat(t, "-").concat(a),
                "".concat(t, "-").concat(l),
                n
        ...
        return u(r({
            ...
            locale: o
        }, e.getLocaleProperties(o)));
    }
    return null;
}, exports.listSupportedLocales = function() {
    for(var e = [], r = 0, n = Object.values(t); r < n.length; r++){
        var a = n[r];
        e.push.apply(e, a);
    }
    return e.sort();
...
"[project]/node_modules/gt-next/dist/provider/ClientProviderWrapper.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var jsx_runtime_1 = __turbopack_context__.r("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-runtime.js [app-ssr] (ecmascript)");
var client_1 = __turbopack_context__.r("[project]/node_modules/gt-react/dist/client.cjs.min.cjs [app-ssr] (ecmascript)");
var navigation_1 = __turbopack_context__.r("[project]/node_modules/next/navigation.js [app-ssr] (ecmascript)");
...
var generaltranslation_1 = __turbopack_context__.r("[project]/node_modules/generaltranslation/dist/index.cjs.min.cjs [app-ssr] (ecmascript)");
function extractLocale(pathname, gt) {
    var matches = pathname.match(/^\/([^\/]+)(?:\/|$)/);
    return matches ? gt.resolveAliasLocale(matches[1]) : null;
}
function ClientProvider(props) {
    var locale = props.locale, locales = props.locales, defaultLocale = props.defaultLocale, gtServicesEnabled = props.gtServicesEnabled, referrerLocaleCookieName = props.referrerLocaleCookieName, localeRoutingEnabledCookieName = props.localeRoutingEnabledCookieName, devApiKey = props.devApiKey, projectId = props.projectId, runtimeUrl = props.runtimeUrl, customMapping = props.customMapping;
    var gt = (0, react_1.useMemo)(function() {
        return new generaltranslation_1.GT({
            devApiKey: devApiKey,
    ...
    (0, react_1.useEffect)(function() {
        ...
        // ----- Referrer Locale ----- //
        if (locale) {
            document.cookie = "".concat(referrerLocaleCookieName, "=").concat(gt.resolveAliasLocale(locale), ";path=/");
        }
        // ----- Middleware ----- //
        // Trigger page reload when locale changes
        // When nav to same route but in diff locale (ie, /en/blog -> /fr/blog), client components were cached and not re-rendered
        var middlewareEnabled = ((_a = document.cookie.split('; ').find(function(row) {
            return row.startsWith("".concat(localeRoutingEnabledCookieName, "="));
        })) === null || _a === void 0 ? void 0 : _a.split('=')[1]) === 'true';
        if (middlewareEnabled) {
            // Extract locale from pathname
            var extractedLocale = extractLocale(pathname, gt) || defaultLocale;
            var pathLocale = gt.determineLocale([
                gtServicesEnabled ? (0, generaltranslation_1.standardizeLocale)(extractedLocale) : extractedLocale,
                defaultLocale
            ], locales);
            if (pathLocale) {
...
"[project]/node_modules/gt-next/dist/plugin/constants.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
exports.SWC_PLUGIN_SUPPORT = '15.2.0';
exports.ROOT_PARAM_STABILITY = {
    unsupported: '0.0.0',
    unstable: '15.2.0',
    experimental: '15.5.0'
};
exports.STABLE_TURBO_CONFIG_VERSION = '15.3.0'; //# sourceMappingURL=constants.js.map
}),
"[project]/node_modules/gt-next/dist/errors/createErrors.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
exports.devApiKeyIncludedInProductionError = "gt-next Error: You are attempting a production build using a development API key. Replace this API key with a production API key when you build your app for production.";
...
var conflictingConfigurationBuildError = function(conflicts) {
    return "gt-next Error: Conflicting configuration".concat(conflicts.length > 1 ? 's' : '', " detected. Please resolve the following conflicts before building your app:\n").concat(conflicts.join('\n'));
};
...
var invalidLocalesError = function(locales) {
    return "gt-next Error: You are using invalid locale codes in your configuration. " + "You must either specify a list of valid locales or use \"customMapping\" to " + "specify aliases for the following invalid locales: ".concat(locales.join(', '), ".");
};
exports.invalidLocalesError = invalidLocalesError;
var invalidCanonicalLocalesError = function(locales) {
    return "gt-next Error: You are using invalid canonical locale codes in your configuration: ".concat(locales.join(', '), ".");
};
...
var createBadFilepathWarning = function(filename, dir) {
    return "gt-next: Found ".concat(filename, " in ").concat(dir.join(' or '), " directory. This is not supported. Please move it to your root directory.");
};
...
exports.disablingCompileTimeHashWarning = "gt-next (plugin): You are disabling compile time hash. This will disable the compiler optimizations.";
...
exports.createStringRenderWarning = createStringRenderWarning; //# sourceMappingURL=createErrors.js.map
}),
"[project]/node_modules/gt-next/dist/index.client.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var createErrors_1 = __turbopack_context__.r("[project]/node_modules/gt-next/dist/errors/createErrors.js [app-ssr] (ecmascript)");
...
//# sourceMappingURL=node_modules_4f463048._.js.map