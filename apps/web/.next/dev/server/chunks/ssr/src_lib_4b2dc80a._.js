...
"[project]/src/lib/saveWorkerManager.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function serializeAndCompressAsync(state) {
    ...
    if (!worker && !initWorker()) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lz$2d$string$2f$libs$2f$lz$2d$string$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["compressToUTF16"])(JSON.stringify(state));
    }
    const id = ++requestId;
    return new Promise((resolve, reject)=>{
        const timeoutId = setTimeout(()=>{
            ...
            if (pending) {
                ...
                try {
                    const compressed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lz$2d$string$2f$libs$2f$lz$2d$string$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["compressToUTF16"])(JSON.stringify(state));
                    resolve(compressed);
                } catch (error) {
                    reject(error);
                }
...
async function decompressAndParseAsync(compressed) {
    ...
    if (!worker && !initWorker()) {
        ...
        try {
            let jsonString = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lz$2d$string$2f$libs$2f$lz$2d$string$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["decompressFromUTF16"])(compressed);
...
async function serializeAndCompressForDBAsync(state) {
    ...
    if (!worker && !initWorker()) {
        // Fallback: serialize and compress on main thread
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lz$2d$string$2f$libs$2f$lz$2d$string$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["compressToEncodedURIComponent"])(JSON.stringify(state));
    }
    const id = ++requestId;
    return new Promise((resolve, reject)=>{
        const timeoutId = setTimeout(()=>{
            ...
            if (pending) {
                ...
                console.warn('Save worker timeout, falling back to main thread');
                try {
                    const compressed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lz$2d$string$2f$libs$2f$lz$2d$string$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["compressToEncodedURIComponent"])(JSON.stringify(state));
                    resolve(compressed);
                } catch (error) {
                    reject(error);
                }
...
"[project]/src/lib/names.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$names$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/names.ts [app-ssr] (ecmascript)");
...
;
;
const DEFAULT_GRID_SIZE = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$device$2d$detect$2f$dist$2f$lib$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isMobile"] ? 50 : 70;
...
function generateLakes(grid, size, seed) {
    ...
    for (const center of selectedCenters){
        ...
        let lakeName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$names$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateWaterName"])('lake');
        while(usedLakeNames.has(lakeName)){
            lakeName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$names$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateWaterName"])('lake');
        }
...
function generateOceans(grid, size, seed) {
    ...
    for (const edge of edges){
        if (edge.tiles.length > 0) {
            ...
            let oceanName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$names$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateWaterName"])('ocean');
            while(usedOceanNames.has(oceanName)){
                oceanName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$names$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateWaterName"])('ocean');
            }
...
function generateAdjacentCities() {
    ...
    for (const direction of directions){
        let name;
        do {
            name = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$names$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateCityName"])();
...
function upgradeServiceBuilding(state, x, y) {
    ...
    const baseCost = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$games$2f$isocity$2f$types$2f$game$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TOOL_INFO"][buildingType]?.cost;
...
function evolveBuilding(grid, x, y, services, demand) {
    ...
    const buildingList = zone === 'residential' ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$games$2f$isocity$2f$types$2f$buildings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RESIDENTIAL_BUILDINGS"] : zone === 'commercial' ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$games$2f$isocity$2f$types$2f$buildings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["COMMERCIAL_BUILDINGS"] : zone === 'industrial' ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$games$2f$isocity$2f$types$2f$buildings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["INDUSTRIAL_BUILDINGS"] : [];
    ...
    const buildingStats = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$games$2f$isocity$2f$types$2f$buildings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BUILDING_STATS"][anchorBuilding.type];
    ...
    for(let y = 0; y < size; y++){
        for(let x = 0; x < size; x++){
            ...
            if (tile.zone !== 'none' && tile.building.type === 'grass') {
                ...
                const buildingList = tile.zone === 'residential' ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$games$2f$isocity$2f$types$2f$buildings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RESIDENTIAL_BUILDINGS"] : tile.zone === 'commercial' ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$games$2f$isocity$2f$types$2f$buildings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["COMMERCIAL_BUILDINGS"] : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$games$2f$isocity$2f$types$2f$buildings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["INDUSTRIAL_BUILDINGS"];
            ...
            const buildingStats = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$games$2f$isocity$2f$types$2f$buildings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BUILDING_STATS"][tile.building.type];
...
function applyBuildingFootprint(grid, originX, originY, buildingType, zone, level, services) {
    const size = getBuildingSize(buildingType);
    const stats = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$games$2f$isocity$2f$types$2f$buildings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BUILDING_STATS"][buildingType] || {
        maxPop: 0,
        maxJobs: 0,
        pollution: 0,
        landValue: 0
        ...
        for(let dy = 0; dy < buildingSize.height; dy++){
            for(let dx = 0; dx < buildingSize.width; dx++){
                ...
                if (dx === 0 && dy === 0) {
                    ...
                    const stats = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$games$2f$isocity$2f$types$2f$buildings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BUILDING_STATS"][type];
                    if (stats) {
...
"[project]/src/lib/renderConfig.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/multiplayer/types.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/multiplayer/database.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const supabase = supabaseUrl && supabaseKey ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(supabaseUrl, supabaseKey) : null;
...
async function createGameRoom(roomCode, cityName, gameState) {
    ...
    try {
        ...
        const compressed = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$saveWorkerManager$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["serializeAndCompressForDBAsync"])(gameState);
...
async function loadGameRoom(roomCode) {
    ...
    try {
        ...
        const decompressed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lz$2d$string$2f$libs$2f$lz$2d$string$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["decompressFromEncodedURIComponent"])(data.game_state);
        if (!decompressed) {
...
"[project]/src/lib/multiplayer/supabaseProvider.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@supabase/supabase-js/dist/index.mjs [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$multiplayer$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/multiplayer/types.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$multiplayer$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/multiplayer/database.ts [app-ssr] (ecmascript)");
...
class MultiplayerProvider {
    ...
    constructor(options){
        ...
        this.peerId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$multiplayer$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generatePlayerId"])();
        this.gameState = options.initialGameState || null;
        this.isCreator = !!options.initialGameState;
        // Create player info
        this.player = {
            id: this.peerId,
            name: options.playerName || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$multiplayer$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generatePlayerName"])(),
            color: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$multiplayer$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generatePlayerColor"])(),
            joinedAt: Date.now(),
            isHost: false
        };
        // Add self to players
    ...
    async connect() {
        ...
        if (this.isCreator && this.gameState) {
            ...
            try {
                const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$multiplayer$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createGameRoom"])(this.roomCode, this.options.cityName, this.gameState);
                if (!success) {
                    this.options.onError?.((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gt$2d$next$2f$dist$2f$index$2e$client$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["msg"])('Failed to create room in database'));
                    throw new Error((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gt$2d$next$2f$dist$2f$index$2e$client$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["msg"])('Failed to create room in database'));
                }
            } catch (e) {
                if (e instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$multiplayer$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CitySizeLimitError"]) {
            ...
            const roomData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$multiplayer$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loadGameRoom"])(this.roomCode);
            if (!roomData) {
                this.options.onError?.((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gt$2d$next$2f$dist$2f$index$2e$client$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["msg"])('Room not found'));
                throw new Error((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gt$2d$next$2f$dist$2f$index$2e$client$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["msg"])('Room not found'));
            }
        ...
        .on('presence', {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$multiplayer$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updatePlayerCount"])(this.roomCode, this.players.size);
        }).on('presence', {
            event: 'join'
        }, ({ key, newPresences })=>{
   ...
   */ updateGameState(state) {
    ...
    saveStateToDatabase(state) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$multiplayer$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateGameRoom"])(this.roomCode, state).catch((e)=>{
            if (e instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$multiplayer$2f$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CitySizeLimitError"]) {
...
"[project]/src/lib/vcSimulation.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const API_BASE_URL = process.env.NEXT_PUBLIC_VC_SIM_API_BASE_URL?.replace(/\/$/, '') || 'http://localhost:8000';
...
"[project]/src/lib/investorProfiles.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=src_lib_4b2dc80a._.js.map