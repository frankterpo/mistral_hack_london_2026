...
var generaltranslation_2 = require("generaltranslation");
...
var NEXT_JS_SOURCE_MAP_PATH = '/__nextjs_source-map';
/**
...
function createNextMiddleware(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.localeRouting, localeRouting = _c === void 0 ? true : _c, _d = _b.prefixDefaultLocale, prefixDefaultLocale = _d === void 0 ? false : _d, _e = _b.ignoreSourceMaps, ignoreSourceMaps = _e === void 0 ? true : _e, _f = _b.pathConfig, pathConfig = _f === void 0 ? {} : _f;
    // i18n config
    var envParams;
    ...
    // gt instance
    var gt = new generaltranslation_2.GT({
        customMapping: envParams === null || envParams === void 0 ? void 0 : envParams.customMapping,
    });
    // using gt services
    ...
    var canonicalLocales = Object.values(((envParams === null || envParams === void 0 ? void 0 : envParams.customMapping) || {}))
        .filter(function (locale) { return locale.code; })
        .map(function (locale) { return locale.code; });
    locales.push.apply(locales, canonicalLocales);
    ...
    var warningLocales = locales.filter(function (locale) { return !gt.isValidLocale(locale); });
    ...
    var _g = (0, utils_1.createPathToSharedPathMap)(pathConfig, prefixDefaultLocale, defaultLocale), pathToSharedPath = _g.pathToSharedPath, defaultLocalePaths = _g.defaultLocalePaths;
    /**
    ...
    function middleware(req) {
        ...
        // ---------- LOCALE DETECTION ---------- //
        var _a = (0, utils_1.getLocaleFromRequest)(req, defaultLocale, locales, localeRouting, gtServicesEnabled, prefixDefaultLocale, defaultLocalePaths, referrerLocaleCookieName, localeCookieName, resetLocaleCookieName, gt), userLocale = _a.userLocale, pathnameLocale = _a.pathnameLocale, unstandardizedPathnameLocale = _a.unstandardizedPathnameLocale, clearResetCookie = _a.clearResetCookie;
