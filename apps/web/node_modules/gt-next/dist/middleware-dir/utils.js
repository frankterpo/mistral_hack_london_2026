 ...
 */
function getLocaleFromRequest(req, defaultLocale, approvedLocales, localeRouting, gtServicesEnabled, prefixDefaultLocale, defaultLocalePaths, referrerLocaleCookieName, localeCookieName, resetLocaleCookieName, gt) {
    var _a;
    ...
    if (localeRouting) {
        ...
        if (extractedLocale &&
            ...
            var determinedLocale = gt.determineLocale([extractedLocale], approvedLocales);
            if (determinedLocale) {
    ...
    if ((cookieLocale === null || cookieLocale === void 0 ? void 0 : cookieLocale.value) && gt.isValidLocale(cookieLocale === null || cookieLocale === void 0 ? void 0 : cookieLocale.value)) {
    ...
    var referrerLocaleCookie = req.cookies.get(referrerLocaleCookieName);
    if ((referrerLocaleCookie === null || referrerLocaleCookie === void 0 ? void 0 : referrerLocaleCookie.value) &&
        gt.isValidLocale(referrerLocaleCookie.value) &&
        !clearResetCookie) {
        var referrerLocale = referrerLocaleCookie.value;
    ...
    var unstandardizedUserLocale = gt.determineLocale(candidates.filter(function (locale) { return gt.isValidLocale(locale); }), approvedLocales) || defaultLocale;
