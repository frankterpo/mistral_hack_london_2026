...
import { RenderMethod, TranslatedChildren, Dictionary } from 'gt-react/internal';
...
export default class I18NConfiguration {
     ...
     */
    getDictionaryTranslations(locale: string): Promise<Dictionary | undefined>;
    /**
     * Set the dictionary for a given locale
     * @param {string} locale - The locale code.
     * @param {Dictionary} dictionary - The dictionary data.
     */
    setDictionaryTranslations(locale: string, dictionary: Dictionary): void;
    /**
