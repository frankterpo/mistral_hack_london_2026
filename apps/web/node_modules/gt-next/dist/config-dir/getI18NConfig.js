...
function getI18NConfig() {
    ...
    if (I18NConfigParams) {
        ...
        globalObj._GENERALTRANSLATION_I18N_CONFIG_INSTANCE = new I18NConfiguration_1.default(__assign(__assign({}, defaultWithGTConfigProps_1.default), { locales: [defaultLocale], renderSettings: (0, internal_1.getDefaultRenderSettings)(process.env.NODE_ENV), apiKey: apiKey, projectId: projectId, devApiKey: devApiKey, runtimeUrl: undefined, cacheUrl: null, loadTranslationsType: 'disabled', loadDictionaryEnabled: false }));
    }
    return globalObj._GENERALTRANSLATION_I18N_CONFIG_INSTANCE;
}
