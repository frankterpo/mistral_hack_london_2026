...
const CATEGORY_LABELS: Record<string, unknown> = {
  TOOLS: msg('Tools'),
  ZONES: msg('VC Ecosystem'),
  tools: msg('Tools'),
  zones: msg('VC Ecosystem'),
  zoning: msg('Strategy'),
  expandCity: msg('Expand City'),
  services: msg('Operations'),
  parks: msg('Culture'),
  sports: msg('Sports'),
  waterfront: msg('Waterfront'),
  community: msg('Community'),
  utilities: msg('Infrastructure'),
  special: msg('Special'),
};
    ...
    <div className="w-56 bg-sidebar border-r border-sidebar-border flex flex-col h-screen fixed left-0 top-0 z-40">
      <div className="px-4 py-4 border-b border-sidebar-border">
        <div className="flex items-center justify-between">
          <span className="text-sidebar-foreground font-bold tracking-tight">ISOBUSINESS</span>
