...
export const TOOL_INFO: Record<Tool, ToolInfo> = {
  ...
  zone_residential: { name: msg('Founder Talent'), cost: 50, description: msg('Attract founders and talent') },
  zone_commercial: { name: msg('Startup HQ'), cost: 50, description: msg('Establish startup headquarters') },
  zone_industrial: { name: msg('R&D Lab'), cost: 50, description: msg('Deep tech and research labs') },
  ...
  police_station: { name: msg('Compliance'), cost: 500, description: msg('Legal and regulatory compliance'), size: 1 },
  fire_station: { name: msg('Fire Station'), cost: 500, description: msg('Fight fires'), size: 1 },
  hospital: { name: msg('Wellness'), cost: 1000, description: msg('Employee wellness and health (2x2)'), size: 2 },
  school: { name: msg('School'), cost: 400, description: msg('Basic education (2x2)'), size: 2 },
  university: { name: msg('Accelerator'), cost: 2000, description: msg('Startup accelerator and incubator (3x3)'), size: 3 },
