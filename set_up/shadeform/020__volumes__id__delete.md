...
POST/volumes/{id}/delete/volumes/{id}/deleteCopy
```
curl --request POST \
  --url https://api.shadeform.ai/v1/volumes/{id}/delete \
  --header 'X-API-KEY: <api-key>'
...
200
Confirms the deletion of the specified storage volume.

[/volumes/{id}/info](/api-reference/volumes/volumes-info)[/volumes/types](/api-reference/volumes/volumes-types)⌘I