...
POST/instances/{id}/update/instances/{id}/updateCopy
```
curl --request POST \
  --url https://api.shadeform.ai/v1/instances/{id}/update \
  --header 'Content-Type: application/json' \
...
application/json[​](#body-name)namestring
...
[/instances/{id}/info](/api-reference/instances/instances-info)[/instances/{id}/delete](/api-reference/instances/instances-delete)⌘I