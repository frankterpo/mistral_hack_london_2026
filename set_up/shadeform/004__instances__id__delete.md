...
POST/instances/{id}/delete/instances/{id}/deleteCopy
```
curl --request POST \
  --url https://api.shadeform.ai/v1/instances/{id}/delete \
  --header 'X-API-KEY: <api-key>'
...
Deleting an Instance](/getting-started/quickstart#deleting-the-instance)
#### Authorizations
...
[/instances/{id}/update](/api-reference/instances/instances-update)[/instances/{id}/restart](/api-reference/instances/instances-restart)⌘I