...
POST/sshkeys/{id}/setdefault/sshkeys/{id}/setdefaultCopy
```
curl --request POST \
  --url https://api.shadeform.ai/v1/sshkeys/{id}/setdefault \
  --header 'X-API-KEY: <api-key>'
...
200
Confirms that the specified SSH Key was as set as the default key.

[/sshkeys](/api-reference/sshkeys/sshkeys)[/volumes/create](/api-reference/volumes/volumes-create)⌘I