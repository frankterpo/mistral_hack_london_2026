...
[​](#response-ssh-keys)ssh_keysobject[]required
Show child attributes

[/sshkeys/{id}/delete](/api-reference/sshkeys/sshkeys-delete)[/sshkeys/{id}/setdefault](/api-reference/sshkeys/sshkeys-setdefault)⌘I