...
/templates/{template_id}/deleteCopy
```
curl --request POST \
...
POST/templates/{template_id}/delete/templates/{template_id}/deleteCopy
```
curl --request POST \
  --url https://api.shadeform.ai/v1/templates/{template_id}/delete \
  --header 'X-API-KEY: <api-key>'
...
[/templates/{template_id}/update](/api-reference/templates/templates-update)[Authentication](/api-reference/authentication)⌘I