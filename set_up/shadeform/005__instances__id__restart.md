...
POST/instances/{id}/restart/instances/{id}/restartCopy
```
curl --request POST \
  --url https://api.shadeform.ai/v1/instances/{id}/restart \
  --header 'X-API-KEY: <api-key>'
...
Restarting an Instance](/getting-started/quickstart#restarting-the-instance)
#### Authorizations
...
[/instances/{id}/delete](/api-reference/instances/instances-delete)[/instances/types](/api-reference/instances/instances-types)⌘I