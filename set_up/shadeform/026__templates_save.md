...
POST/templates/save/templates/saveCopy
```
curl --request POST \
  --url https://api.shadeform.ai/v1/templates/save \
  --header 'Content-Type: application/json' \
...
[/templates/featured](/api-reference/templates/templates-featured)[/templates/{template_id}/update](/api-reference/templates/templates-update)⌘I