...
GET/volumes/types/volumes/typesCopy
```
curl --request GET \
  --url https://api.shadeform.ai/v1/volumes/types \
  --header 'X-API-KEY: <api-key>'
...
[​](#response-volume-types)volume_typesobject[]required
Show child attributes

[/volumes/{id}/delete](/api-reference/volumes/volumes-delete)[/volumes](/api-reference/volumes/volumes)⌘I