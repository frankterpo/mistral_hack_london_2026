...
GET/clusters/{id}/info/clusters/{id}/infoCopy
```
curl --request GET \
  --url https://api.shadeform.ai/v1/clusters/{id}/info \
  --header 'X-API-KEY: <api-key>'
...
[​](#response-region-info)region_infoobjectrequired
Show child attributes

[​](#response-status)statusstringrequired
...
[​](#response-updated-at)updated_atstring<date-time>required
...
[​](#response-hourly-price)hourly_priceintegerrequired
The hourly price of the cluster in cents.

Example:
`1500`

[​](#response-cloud-cluster-id-one-of-0)cloud_cluster_idstring | null
The cloud provider assigned cluster ID.

Example:
`"cluster-abc123"`

[​](#response-status-details-one-of-0)status_detailsstring | null
Additional details about the cluster status.

Example:
`"Cluster is provisioning"`

[​](#response-cost-estimate-one-of-0)cost_estimatestring | null
Estimated cost of the cluster.

Example:
`"$15.00"`

[​](#response-active-at-one-of-0)active_atstring<date-time> | null
The timestamp when the cluster became active.

[/clusters/create](/api-reference/clusters/clusters-create)[/clusters/{id}/delete](/api-reference/clusters/clusters-delete)⌘I