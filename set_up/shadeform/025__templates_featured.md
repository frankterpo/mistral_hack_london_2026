...
GET/templates/featured/templates/featuredCopy
```
curl --request GET \
  --url https://api.shadeform.ai/v1/templates/featured \
  --header 'X-API-KEY: <api-key>'
...
[​](#response-templates)templatesobject[]required
Show child attributes

[/templates/{template_id}/info](/api-reference/templates/templates-info)[/templates/save](/api-reference/templates/templates-save)⌘I