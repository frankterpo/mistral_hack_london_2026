...
POST/clusters/create/clusters/createCopy
```
curl --request POST \
  --url https://api.shadeform.ai/v1/clusters/create \
  --header 'Content-Type: application/json' \
...
[​](#body-cloud)cloudstringrequired
...
[​](#body-cluster-type)cluster_typestringrequired
The type of GPU cluster to create.

Example:
`"H100_sxm5x8"`

[​](#body-num-instances)num_instancesintegerrequired
...
[/instances](/api-reference/instances/instances)[/clusters/{id}/info](/api-reference/clusters/clusters-info)⌘I