...
GET/sshkeys/{id}/info/sshkeys/{id}/infoCopy
```
curl --request GET \
  --url https://api.shadeform.ai/v1/sshkeys/{id}/info \
  --header 'X-API-KEY: <api-key>'
...
[​](#response-public-key)public_keystringrequired
The public key.
...
[​](#response-is-default)is_defaultbooleanrequired
Indicates the default key.

Example:
`false`

[/sshkeys/add](/api-reference/sshkeys/sshkeys-add)[/sshkeys/{id}/delete](/api-reference/sshkeys/sshkeys-delete)⌘I