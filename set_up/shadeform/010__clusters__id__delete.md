...
/clusters/{id}/deleteCopy
```
curl --request POST \
  --url https://api.shadeform.ai/v1/clusters/{id}/delete \
  --header 'X-API-KEY: <api-key>'
```

POST/clusters/{id}/delete/clusters/{id}/deleteCopy
```
curl --request POST \
  --url https://api.shadeform.ai/v1/clusters/{id}/delete \
  --header 'X-API-KEY: <api-key>'
...
[/clusters/{id}/info](/api-reference/clusters/clusters-info)[/clusters/types](/api-reference/clusters/clusters-types)⌘I