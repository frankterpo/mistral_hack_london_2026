...
POST/volumes/create/volumes/createCopy
```
curl --request POST \
  --url https://api.shadeform.ai/v1/volumes/create \
  --header 'Content-Type: application/json' \
...
[​](#body-size-in-gb)size_in_gbintegerrequired
...
[/sshkeys/{id}/setdefault](/api-reference/sshkeys/sshkeys-setdefault)[/volumes/{id}/info](/api-reference/volumes/volumes-info)⌘I